...
class TestAllNaturalCustomer {
	...
	@Test
	void TestAllNaturalCustomerbyCode() {
		...
		<CTSMessage>
			...
			<Data>
				<ProcedureRequest>
					<SpName>cob_procesador..sp_se_ente_ofi</SpName>
					<Param name="@t_trn" type="56" io="0" len="7">1875058</Param>
					<Param name="@i_subtipo" type="47" io="0" len="1">P</Param>
					<Param name="@i_tipo" type="56" io="0" len="1">1</Param>
					<Param name="@i_ente" type="47" io="0" len="1">44</Param>
	...
	@Test
	void TestAllNaturalCustomerbyAlphabetical() {
		...
		<CTSMessage>
			...
			<Data>
				<ProcedureRequest>
					...
					<Param name="@i_nombre" type="47" io="0" len="1">NOMBRE1 32</Param>
					<Param name="@i_p_apellido" type="47" io="0" len="1">APELLIDO1 32</Param>
					<Param name="@i_modo" type="56" io="0" len="1">0</Param>
				</ProcedureRequest>
			</Data>
		</CTSMessage>'''
	...
	@Test
	void TestAllNaturalCustomerbyMarriedName() {
		...
		<CTSMessage>
			...
			<Data>
				<ProcedureRequest>
					...
					<Param name="@i_c_apellido" type="47" io="0" len="1">APELLIDO1</Param>
					<Param name="@i_modo" type="56" io="0" len="1">0</Param>
				</ProcedureRequest>
			</Data>
		</CTSMessage>'''
	...
	@Test
	void TestAllNaturalCustomerbyId() {
		...
		<CTSMessage>
			...
			<Data>
				<ProcedureRequest>
					...
					<Param name="@t_trn" type="56" io="0" len="7">1875058</Param>
					<Param name="@i_subtipo" type="47" io="0" len="1">P</Param>
					<Param name="@i_tipo" type="56" io="0" len="1">8</Param>
