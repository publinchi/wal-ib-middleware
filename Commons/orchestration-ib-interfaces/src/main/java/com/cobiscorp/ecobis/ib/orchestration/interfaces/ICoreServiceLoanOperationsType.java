 ...
 *
 */
public interface ICoreServiceLoanOperationsType {
	...
	<ul>
		LoanOperationsTypeResponse loanOperationsTypeResponse = new LoanOperationsTypeResponse();
		<!--
		...
		<li>aLoanStatement.setPaymentType("A");//validar sp q no viene este valor</li>
	 ...
	 */
	LoanOperationsTypeResponse GetLoans (LoanSimulationRequest loanSimulationRequest)  throws CTSServiceException, CTSInfrastructureException;
}
