 ...
 *
 */
class Test_ib_checkbook_request_checkbook_query {
	@ClassRule
	...
	void testgetRequestCheckbook() {
		...
		try{
			...
			wCheckbookRequest.account=CTSEnvironment.bvAccCtaCteNumber;//@i_cta
			wCheckbookRequest.currency=CTSEnvironment.bvAccDpfCurrencyId;//@i_mon
			...
			wCheckbookRequest.userName=CTSEnvironment.bvLogin;//@i_login
