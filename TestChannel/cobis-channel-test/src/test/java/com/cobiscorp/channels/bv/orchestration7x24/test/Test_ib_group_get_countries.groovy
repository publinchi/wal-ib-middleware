...
/**
 * get catalog of Countries for Group user
 * 
 * @author dguerra
 * @since Sep 1, 2014
 * @version 1.0.0
...
public class Test_ib_group_get_countries {
	...
	@Test
	void testGroupGetCountriesCatalog() {
		def ServiceName='testGroupGetCountriesCatalog'
		try{
