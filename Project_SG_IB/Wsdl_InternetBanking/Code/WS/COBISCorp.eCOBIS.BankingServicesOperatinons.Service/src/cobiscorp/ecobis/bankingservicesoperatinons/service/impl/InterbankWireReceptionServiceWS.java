    ...
    package cobiscorp.ecobis.bankingservicesoperatinons.service.impl;
...
import cobiscorp.ecobis.commons.dto2.CobisHeader;
    ...
    import cobiscorp.ecobis.bankingservicesoperatinons.service.security.COBISSecurityManager;
    ...
    import java.lang.reflect.Field;
        ...
        import ws.cobiscorp.ecobis.bankingservicesoperatinons.service.InterbankWireReceptionService;
      
import cobiscorp.ecobis.bankingservicesoperation.dto.*;
   
      @WebService(endpointInterface = "ws.cobiscorp.ecobis.bankingservicesoperatinons.service.InterbankWireReceptionService"
     )
    public class InterbankWireReceptionServiceWS implements InterbankWireReceptionService
    {
    @Resource
    private WebServiceContext wsCtx;

    private static ILogger logger = LogFactory.getLogger(InterbankWireReceptionServiceWS.class);
    
      /**
      * 
      **/
      @SuppressWarnings("unchecked")
          public CTSServiceResponseTO  frameReceptionService(PayOrderDetailRequest inPayOrderDetailRequest) {
      String operationName = "InterbankWireReceptionService.frameReceptionService";
      ...
      serviceRequestTO.setServiceId("BankingServicesOperatinons.InterbankWireReceptionService.WireReceptionService");
      ...
      return response;
            ...
            if(serviceResponseTO.getData().containsKey("returnPayOrderDetailResponse")){
            }
