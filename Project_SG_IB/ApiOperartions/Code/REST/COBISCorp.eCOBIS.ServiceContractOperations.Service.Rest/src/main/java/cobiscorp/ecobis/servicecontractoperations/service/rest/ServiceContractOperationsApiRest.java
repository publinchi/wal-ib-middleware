...
*/
  ...
  @Produces({"application/json"})
    public Response  getUniqueId(
    		...
    		@NotNull(message = "WM_CONSUMER.ID may not be null") 
    		@HeaderParam("WM_CONSUMER.ID") String wmconsumer_id,
    		@NotNull(message = "WM_SEC.AUTH_SIGNATURE may not be null") 
    		@HeaderParam("WM_SEC.AUTH_SIGNATURE") String wmsec_authsignature,
    		@NotNull(message = "WM_CONSUMER.INTIMESTAMP may not be null") 
    		@HeaderParam("WM_CONSUMER.INTIMESTAMP") String wmconsumer_intimestamp,
    		...
    		@NotNull(message = "FLOW_NAME may not be null") 
    		@HeaderParam("FLOW_NAME") String flow_name,      		     		
