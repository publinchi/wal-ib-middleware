...
class Test_ib_payment_loan_group {
	@ClassRule
	...
	@Test
	void testPaymentLoanGroup() {
		def ServiceName= 'testPaymentLoanGroup'
		try{
			...
			wPaymentRequet.userName= CTSEnvironment.bvGroupLogin 
			wPaymentRequet.account= CTSEnvironment.bvGroupAccCtaAhoNumber//'10410000005233616'
			wPaymentRequet.concept='Pago Prestamo regresion Grupo'
			...
			wPaymentRequet.destProduct = CTSEnvironment.bvAccCarType //7
			...
			def message=''
				...
				if (serviceResponseTO.messages.toList().size()>0){
					...
					if(wOAutorizacion.equals("S")){
						println "=============================================================="
						println "*****Verificando Validación de doble Autorización para Grupos"
