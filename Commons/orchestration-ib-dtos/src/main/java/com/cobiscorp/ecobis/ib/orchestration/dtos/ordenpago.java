...
public class ordenpago implements Serializable{
	...
	@XmlElement
	private String OpFechaCap;

	@XmlElement
	private Integer OpClave;
	...
	@XmlElement
	private String OpRefCobranza;

	@XmlElement
	private Integer OpFolioServidor;

	@XmlElement
	private String OpUsuAutoriza;

	@XmlElement
	private Integer OpErrClave;

	@XmlElement
	private String OpRazonRechazo;

	@XmlElement
	private String OpHoraCap;

	@XmlElement
	private String OpHoraLiqBm;

	@XmlElement
	private String OpHoraLiqSist;
	...
	public String getOpFechaCap() {
		return OpFechaCap;
	}

	public void setOpFechaCap(String opFechaCap) {
		OpFechaCap = opFechaCap;
	}

	public Integer getOpClave() {
		return OpClave;
	}

	public void setOpClave(Integer opClave) {
		OpClave = opClave;
	}

	public String getOpRfcCurpBen() {
		return OpRfcCurpBen;
	}

	public void setOpRfcCurpBen(String opRfcCurpBen) {
		OpRfcCurpBen = opRfcCurpBen;
	}

	public String getOpRefCobranza() {
		return OpRefCobranza;
	}

	public void setOpRefCobranza(String opRefCobranza) {
		OpRefCobranza = opRefCobranza;
	}

	public Integer getOpFolioServidor() {
		return OpFolioServidor;
	}

	public void setOpFolioServidor(Integer opFolioServidor) {
		OpFolioServidor = opFolioServidor;
	}

	public String getOpUsuAutoriza() {
		return OpUsuAutoriza;
	}

	public void setOpUsuAutoriza(String opUsuAutoriza) {
		OpUsuAutoriza = opUsuAutoriza;
	}

	public Integer getOpErrClave() {
		return OpErrClave;
	}

	public void setOpErrClave(Integer opErrClave) {
		OpErrClave = opErrClave;
	}

	public String getOpRazonRechazo() {
		return OpRazonRechazo;
	}

	public void setOpRazonRechazo(String opRazonRechazo) {
		OpRazonRechazo = opRazonRechazo;
	}

	public String getOpHoraCap() {
		return OpHoraCap;
	}

	public void setOpHoraCap(String opHoraCap) {
		OpHoraCap = opHoraCap;
	}
	...
	public void setOpHoraLiqBm(String opHoraLiqBm) {
		OpHoraLiqBm = opHoraLiqBm;
	}

	public String getOpHoraLiqSist() {
		return OpHoraLiqSist;
	}

	public void setOpHoraLiqSist(String opHoraLiqSist) {
		OpHoraLiqSist = opHoraLiqSist;
	}
	...
	public BigDecimal getOpIva() {
		return OpIva;
	}

	public void setOpIva(BigDecimal opIva) {
		OpIva = opIva;
	}

	public String getEstadoJob() { return estadoJob; }

	public void setEstadoJob(String estadoJob) { this.estadoJob = estadoJob; }
	...
	public String toString(){
		...
		builder.append("{");
		builder.append("\"OpFechaOper\":" + "\"" + getOpFechaOper() + "\"" + ",");
		builder.append("\"OpFolio\":" + "\"" + getOpFolio() + "\"" + ",");
		builder.append("\"OpInsClave\":" + "\"" + getOpInsClave() + "\"" + ",");
		builder.append("\"OpMonto\":" + "\"" + getOpMonto() + "\"" + ",");
		builder.append("\"OpTpClave\":" + "\"" + getOpTpClave() + "\"" + ",");
		builder.append("\"OpCveRastreo\":" + "\"" + getOpCveRastreo() + "\"" + ",");
		builder.append("\"OpEstado\":" + "\"" + getOpEstado() + "\"" + ",");
		builder.append("\"OpTipoOrden\":" + "\"" + getOpTipoOrden() + "\"" + ",");
		builder.append("\"OpPrioridad\":" + "\"" + getOpPrioridad() + "\"" + ",");
		builder.append("\"OpTopologia\":" + "\"" + getOpTopologia() + "\"" + ",");
		builder.append("\"OpMeClave\":" + "\"" + getOpMeClave() + "\"" + ",");
		builder.append("\"OpUsuClave\":" + "\"" + getOpUsuClave() + "\"" + ",");
		builder.append("\"OpFechaCap\":" + "\"" + getOpFechaCap() + "\"" + ",");
		builder.append("\"OpClave\":" + "\"" + getOpClave() + "\"" + ",");
		builder.append("\"OpNomOrd\":" + "\"" + getOpNomOrd() + "\"" + ",");
		builder.append("\"OpTcClaveOrd\":" + "\"" + getOpTcClaveOrd() + "\"" + ",");
		builder.append("\"OpCuentaOrd\":" + "\"" + getOpCuentaOrd() + "\"" + ",");
		builder.append("\"OpRfcCurpOrd\":" + "\"" + getOpRfcCurpOrd() + "\"" + ",");
		builder.append("\"OpNomBen\":" + "\"" + getOpNomBen() + "\"" + ",");
		builder.append("\"OpTcClaveBen\":" + "\"" + getOpTcClaveBen() + "\"" + ",");
		builder.append("\"OpCuentaBen\":" + "\"" + getOpCuentaBen() + "\"" + ",");
		builder.append("\"OpRfcCurpBen\":" + "\"" + getOpRfcCurpBen() + "\"" + ",");
		builder.append("\"OpNomBen2\":" + "\"" + getOpNomBen2() + "\"" + ",");
		builder.append("\"OpTcClaveBen2\":" + "\"" + getOpTcClaveBen2() + "\"" + ",");
		builder.append("\"OpCuentaBen2\":" + "\"" + getOpCuentaBen2() + "\"" + ",");
		builder.append("\"OpConceptoPago\":" + "\"" + getOpConceptoPago() + "\"" + ",");
		builder.append("\"OpRefNumerica\":" + "\"" + getOpRefNumerica() + "\"" + ",");
		builder.append("\"OpRefCobranza\":" + "\"" + getOpRefCobranza() + "\"" + ",");
		builder.append("\"OpFolioServidor\":" + "\"" + getOpFolioServidor() + "\"" + ",");
		builder.append("\"OpUsuAutoriza\":" + "\"" + getOpUsuAutoriza() + "\"" + ",");
		builder.append("\"OpErrClave\":" + "\"" + getOpErrClave() + "\"" + ",");
		builder.append("\"OpRazonRechazo\":" + "\"" + getOpRazonRechazo() + "\"" + ",");
		builder.append("\"OpHoraCap\":" + "\"" + getOpHoraCap() + "\"" + ",");
		builder.append("\"OpHoraLiqBm\":" + "\"" + getOpHoraLiqBm() + "\"" + ",");
		builder.append("\"OpHoraLiqSist\":" + "\"" + getOpHoraLiqSist() + "\"" + ",");
		builder.append("\"OpCde\":" + "\"" + getOpCde() + "\"" + ",");
		builder.append("\"opFirmaDig\":" + "\"" + getOpFirmaDig() + "\"" + ",");
		builder.append("\"OpToClave\":" + "\"" + getOpToClave() + "\"" + ",");
		builder.append("\"OpConceptoPag2\":" + "\"" + getOpConceptoPag2() + "\"" + ",");
		builder.append("\"OpIva\":" + "\"" + getOpIva() + "\"" + ",");
		builder.append("\"EstadoJob\":" + "\"" + getEstadoJob() + "\"" + ",");
		builder.append("\"Intento\":" + "\"" + getIntento() + "\"" + ",");
