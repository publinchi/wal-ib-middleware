 ...
 *
 */
class Test_ib_company_information_credit_card {
	...
	void  GetBalance(String pSession,String pLogin)
	{
		...
		try
		{
			...
			wCreditCard.card = CTSEnvironment.bvAccCompanyTarNumber
			wCreditCard.productId = Integer.parseInt(CTSEnvironment.bvAccCompanyTarType)
