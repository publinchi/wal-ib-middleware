 ...
 *
 */
class Test_ib_group_cashier_check_application {
	...
	void testCashiersCheckAplication() {
		println ' ****** Prueba Regresión testCashiersCheckAplication Grupo************* '
		...
		try{
			...
			wTransactionRequest.userName=CTSEnvironment.bvGroupLogin;//@i_login
			wProduct.productNumber=CTSEnvironment.bvGroupAccCtaAhoNumber;//@i_cta 
			wProduct.productAbbreviation="KK";
			wProduct.currencyId=CTSEnvironment.bvGroupAccCtaAhoCurrencyId;//@i_mon
			wProduct.productId=CTSEnvironment.bvGroupAccCtaAhoType;//@i_product 
			wManagerCheck.amount=250.93;
			wManagerCheck.beneficiary="Jonathan Veloz Christian Grupo";
			wManagerCheck.beneficiaryId="0950527994";
			wManagerCheck.beneficiaryTypeId=CTSEnvironment.bvGroupAccCtaAhoBeneficiaryType;
			wManagerCheck.authorizedPhoneNumber=CTSEnvironment.bvPhone;
			wManagerCheck.destinationOfficeId=CTSEnvironment.bvGroupAccCtaAhoOfficeId;
			wManagerCheck.authorizedTypeId="2";
			wManagerCheck.authorizedId="012345678";
			wManagerCheck.authorized="BENEFICIARIO CHEQUE DE GERENCIA";
			wManagerCheck.email=CTSEnvironment.bvEmail;
			wManagerCheck.purpose="Prueba Solicitud de Cheque de Gerencia Grupo";
			wContext.entityId=CTSEnvironment.bvGroupEnteMis;//137488
			...
			println "******** Output ManagerCheckRequest Group*********"
