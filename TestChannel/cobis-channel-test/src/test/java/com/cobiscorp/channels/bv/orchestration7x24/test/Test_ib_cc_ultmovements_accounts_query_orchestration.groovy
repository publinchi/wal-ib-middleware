...
// PRODUCT: CHECKING ACCOUNT,  TYPE USER: NATURAL USER 
class Test_ib_cc_ultmovements_accounts_query_orchestration {
	@ClassRule
	...
	@Test
	void TestGetCCUltMovementsQuery () {
		def ServiceName='TestGetCCUltMovementsQuery'
		try{
