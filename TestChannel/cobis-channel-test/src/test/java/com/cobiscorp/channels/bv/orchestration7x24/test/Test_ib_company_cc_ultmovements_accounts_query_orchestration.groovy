...
// PRODUCT: CHECKING ACCOUNT,  TYPE USER: COMPANY
public class  Test_ib_company_cc_ultmovements_accounts_query_orchestration {
	@ClassRule
	...
	@Test
	void TestCompanyGetCCUltMovementsQuery () {
		def ServiceName='TestCompanyGetCCUltMovementsQuery'
		try{
