...
class Test_ib_group_information_credit_card {
		...
		void  GetBalance(String pSession,String pLogin)
		{
			...
			try
			{
				...
				wCreditCard.card = CTSEnvironment.bvAccGroupTarNumber
				wCreditCard.productId = Integer.parseInt(CTSEnvironment.bvAccGroupTarType)
		...
		void  GetPrize(String pSession,String pLogin)
		{
			try
			{
				...
				wTransactionRequest.productNumber = CTSEnvironment.bvAccGroupTarNumber
		...
		void testGetInformationCreditCard() {
			...
			GetBalance(initSession, CTSEnvironment.bvGroupLogin)
			GetPrize(initSession, CTSEnvironment.bvGroupLogin)
