...
<script type="text/javascript">
	var nombreClase       = "BalanceProductResponse";
	var tipoDato          = ["BalanceProduct"];
	var nombreAtributo    = ["balanceProduct"];
 ...
 * @version 1.0.0
 */
public class BalanceProductResponse extends BaseResponse {
	...
	/**
	 * @param balanceProduct
	 *            the balanceProduct to set
	 */
	...
	public String toString() {
		return "BalanceProductResponse [balanceProduct=" + balanceProduct + "]";
	}
}
