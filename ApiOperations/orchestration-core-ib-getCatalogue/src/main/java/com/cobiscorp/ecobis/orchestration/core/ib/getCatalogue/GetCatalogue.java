...
@Component(name = "GetCatalogue", immediate = false)
@Service(value = { ICISSPBaseOrchestration.class, IOrchestrator.class })
@Properties(value = { @Property(name = "service.description", value = "GetCatalogue"),
		@Property(name = "service.vendor", value = "COBISCORP"), @Property(name = "service.version", value = "1.0.0"),
		@Property(name = "service.identifier", value = "GetCatalogue"),
		@Property(name = "service.spName", value = "cob_procesador..sp_get_catalog_data") })
public class GetCatalogue extends SPJavaOrchestrationBase {
	...
	public IProcedureResponse executeJavaOrchestration(IProcedureRequest anOriginalRequest,
		...
		if (logger.isInfoEnabled()) {
			logger.logInfo(CLASS_NAME + " Start-executeJavaOrchestration---> getCatalogue");
		}
	...
	private Boolean getCatalogData(java.util.Map<String, Object> aBagSPJavaOrchestration) {
		...
		reqTMP.setSpName("cobis..sp_get_catalog_data");
		reqTMP.addFieldInHeader(ICOBISTS.HEADER_TARGET_ID, 'S', "central");
		reqTMP.addFieldInHeader(ICOBISTS.HEADER_TRN, 'N', "18500087");
