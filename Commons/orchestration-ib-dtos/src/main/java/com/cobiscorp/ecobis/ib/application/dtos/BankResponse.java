...
<script type="text/javascript">
	var nombreClase       = "BankResponse";
	var tipoDato          = ["List < Bank >"];
	var nombreAtributo    = ["bankCollection"];
...
public class BankResponse extends BaseResponse {
	 ...
	 */
	private List<Bank> bankCollection;

	public List<Bank> getBankCollection() {
		return bankCollection;
	}

	public void setBankCollection(List<Bank> bankCollection) {
		this.bankCollection = bankCollection;
	}

	@Override
	public String toString() {
		return "BankResponse [bankCollection=" + bankCollection + "]";
	}
