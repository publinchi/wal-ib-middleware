...
class Test_ib_company_time_deposit_movements_query {
	...
	void testgetTimeDepositMovements(){
		...
		try {
			...
			enquiryRequest.productNumber = CTSEnvironment.bvCompanyDPFNumber;//@i_num_banco
			...
			enquiryRequest.currencyId=CTSEnvironment.bvCompanyDpfCurrencyId;//@i_mon
