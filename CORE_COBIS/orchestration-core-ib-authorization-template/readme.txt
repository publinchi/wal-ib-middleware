...
3) Agregar en el archivo $COBIS_HOME/CTS_MF/infrastructure/cts-ccm-plan-config.xml
	  <plugin name="orchestration-core-ib-authorization-template" path="../../CIS/SERVICES/plugins/IBOrchestration/orchestration-core-ib-authorization-template-4.5.0.jar"/> --> 
	  <plugin name="orchestration-core-ib-authorization-template" path="../../CIS/SERVICES/plugins/IBOrchestration/orchestration-core-ib-authorization-template-4.5.0.jar"/>

3) Recargar desde la consola de CTS el servicio de CTS Transformation

4) Deployar el orchestration-core-ib-authorization-template y orchestration-core-ib-authorization por medio de mvn >  install
