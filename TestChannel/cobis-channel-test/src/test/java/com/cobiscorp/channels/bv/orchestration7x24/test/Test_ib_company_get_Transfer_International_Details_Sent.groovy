...
class Test_ib_company_get_Transfer_International_Details_Sent {
	@ClassRule
	...
	void testGetTransferInternationalDetails(){
		...
		try{
			...
			wSearchOption.setCriteria2("NE")			
			wSearchOption.setSequential(0)
			wSearchOption.setInitialDate("01/01/2011")
			wSearchOption.setFinalDate("10/30/2011")
			wSearchOption.setMode(101)
			wSearchOption.setNumberOfResults(0)
			wSearchOption.setNotes("testCtsEmp")
			wProduct.setProductNumber("10410108275248120") 
			wProduct.setCurrencyId(0)
			wProduct.setProductId(4)
