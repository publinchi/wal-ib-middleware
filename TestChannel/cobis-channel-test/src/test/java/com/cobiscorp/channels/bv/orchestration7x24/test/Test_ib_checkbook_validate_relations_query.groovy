...
class Test_ib_checkbook_validate_relations_query {
	...
	void testValidateRelations(){
		...
		try {			
			...
			serviceRequestTO.setServiceId('InternetBanking.WebApp.EnterpriseServices.UniqueLogin.ValidateAccountsRelations');
			
			Client client = new Client();
			Product product = new Product();
			
			client.entityId = 109106; //@i_cliente
			product.productNumber = '10410109105249819'; //@i_cta
			
			serviceRequestTO.addValue('inClient', client);
