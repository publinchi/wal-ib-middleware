 ...
 * 
 * */
public interface ICoreServiceCreditLine {
	/**
	 * 
	 *   
	...
	**/
	public CreditLineResponse getLines(CreditLineRequest aCreditLineRequest) throws CTSServiceException, CTSInfrastructureException;
