...
class Test_ib_company_add_beneficiary {
	...
	void TestAddBeneficiary(){
		...
		try{
			...
			beneficiary.idBeneficiary="Company"
			...
			beneficiary.identificacion="Tipodirección Test"
			...
			println ('RESPUESTA: @o_guid----->' + wOref)
			...
			Assert.assertEquals("No se encontro registro en la re_tran_monet",wRowbeneficiary.size(), 1)
			println ('RESPUESTA: wRowTranMonet----->'+wRowbeneficiary)
