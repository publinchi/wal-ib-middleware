 ...
 *
 */
class Test_ib_time_deposit_query {
	@ClassRule
	...
	void testgetTimeDepositDetail() {
		println ' ****** Prueba Regresión testgetTimeDepositDetail Persona Natural************* '
		...
		try{
			...
			wEnquiryRequest.userName = CTSEnvironment.bvLogin;//@i_login
			...
			wEnquiryRequest.productNumber=CTSEnvironment.bvAccDpfNumber;//@i_cta
			wEnquiryRequest.currencyId=CTSEnvironment.bvAccDpfCurrencyId;//@i_mon
