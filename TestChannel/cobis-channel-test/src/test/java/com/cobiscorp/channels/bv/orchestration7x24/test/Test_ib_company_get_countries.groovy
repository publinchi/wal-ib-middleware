...
/**
 * get catalog of Countries for Campany user
 * 
 * @author dguerra
 * @since Sep 1, 2014
 * @version 1.0.0
...
public class Test_ib_company_get_countries {
	@ClassRule
	...
	@Test
	void testCompanyGetCountriesCatalog() {
		def ServiceName='testCompanyGetCountriesCatalog'
		try{
