	...
	public ResponseValidateDeviceActivation validateDeviceActivation(
      ...
      throw new CTSRestException("404",null);
		...
		public ResponseAuthorizeReversalDock authorizeReversalDock(String legacyid, String clientid, String uuid,
			...
			ResponseAuthorizeReversalDock outResponseAuthorizeReversalDock = new ResponseAuthorizeReversalDock();
			...
			if (response.getResultSets() != null && response.getResultSets().get(0).getData().getRows().size() > 0) {
				...
				outResponseAuthorizeReversalDock.setResponse(returnResponseAuthorizeReversalDock.getResponse());
				outResponseAuthorizeReversalDock.setReason(returnResponseAuthorizeReversalDock.getReason());
			...
			// returns data
			return outResponseAuthorizeReversalDock;
		}
