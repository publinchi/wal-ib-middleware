 ...
 *
 */
public class Test_ib_authorized_pending_transaction {
	@ClassRule
	...
	/**
	 * Test the authorization of Self Account Transfers 
	 */
	@Test
	void testCompanyApproveDenyPendingAuthorization(){
		String ServiceName='CompanyApproveDenyPendingAuthorization'
		
		def IdAuthorization = 2977
		try{
			...
			wLoginPending.userName = "testCtsEmpA"
			wLoginPending.reason = "REASON PREGRESION"
