 ...
 * @version 1.0.0
 */
class Test_ib_cc_movements_accounts_query_orchestration {
	@ClassRule
	...
	/*Prueba Regresión Nota de Crédito*/
	@Test
	void testNCGetCcMovementsAccountQuery() {
		MovementsAccountQuery("NC")
	}
	/*Prueba Regresión Nota de Débitos*/
	@Test
	void testNDGetCcMovementsAccountQuery() {
		MovementsAccountQuery("NC")
	}
	/*Prueba Regresión Transferencias al exterior*/
	@Test
	void testAllGetCcMovementsAccountQuery() {
		MovementsAccountQuery("TE")
	}
	
	/*Prueba Regresión Prestamos*/
	@Test
	void testPGetCcMovementsAccountQuery() {
		MovementsAccountQuery("L")
	}

	/*Prueba Regresión TODOS LOS MOVIMIENTOS*/
	@Test
	void testTGetCcMovementsAccountQuery() {
		MovementsAccountQuery("T")
	}
	
	void MovementsAccountQuery(String pType){
