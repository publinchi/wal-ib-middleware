...
//Init map returns
    ...
    */
	...
	procedureRequestAS.addInputParam("@i_card_number",ICTSTypes.SQLVARCHAR,inRequestRegisterCardPan.getCard_number());
	procedureRequestAS.addInputParam("@x_request_id",ICTSTypes.SQLVARCHAR,xrequestid);
	procedureRequestAS.addInputParam("@x_end_user_request_date",ICTSTypes.SQLVARCHAR,xenduserrequestdatetime);
	procedureRequestAS.addInputParam("@x_end_user_ip",ICTSTypes.SQLVARCHAR,xenduserip);
	procedureRequestAS.addInputParam("@x_channel",ICTSTypes.SQLVARCHAR,xchannel);
	...
	int mapBlank=0;
		  ...
		  if (response.getResultSets()!=null&&response.getResultSets().get(0).getData().getRows().size()>0) {	
							  //---------NO Array
							  ResponseRegisterCardPan returnResponseRegisterCardPan = MapperResultUtil.mapOneRowToObject(response.getResultSets().get(0), new RowMapper<ResponseRegisterCardPan>() { 
				  @Override
		  ...
		  if (response.getResultSets()!=null&&response.getResultSets().get(1).getData().getRows().size()>0) {	
							  //---------NO Array
							  ResponseRegisterCardPan returnResponseRegisterCardPan = MapperResultUtil.mapOneRowToObject(response.getResultSets().get(1), new RowMapper<ResponseRegisterCardPan>() { 
				  @Override
				  public ResponseRegisterCardPan mapRow(ResultSetMapper resultSetMapper, int index) {
				  ResponseRegisterCardPan dto = new ResponseRegisterCardPan();
		  ...
		  if (response.getResultSets()!=null&&response.getResultSets().get(2).getData().getRows().size()>0) {	
							  //---------NO Array
							  ResponseRegisterCardPan returnResponseRegisterCardPan = MapperResultUtil.mapOneRowToObject(response.getResultSets().get(2), new RowMapper<ResponseRegisterCardPan>() { 
				  @Override
				  public ResponseRegisterCardPan mapRow(ResultSetMapper resultSetMapper, int index) {
				  ResponseRegisterCardPan dto = new ResponseRegisterCardPan();
