 ...
 *
 */
class Test_ib_third_party_transfer {
	...
	void testExecuteTransferToThird() {
		...
		try{
			...
			wProduct.productNumber= '10410108275249013'
			wProduct.productId=4
			wProduct.currencyId= 0
			wProduct.productAbbreviation ='AHOS'
			print (wProduct.getProductNumber())
			

			wProductDestino.productNumber= '10410108275248120'
			wProductDestino.productId=4
			wProductDestino.currencyId= 0
			...
			print (wProduct.getProductNumber())
			print ("***********************" + wProduct.getProductId() + "***********************")
			print (wProductDestino.getProductNumber())
	 ...
	 */
	@Test
	void testExecuteTransferToThirdOverdraft() {
		String ServiceName='TransferToThird'
		try{
