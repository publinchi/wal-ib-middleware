...
<script type="text/javascript">
	var nombreClase       = "ContractResponse";
	var tipoDato          = ["List<Contract>"];
	var nombreAtributo    = ["listContract"];
...
public class ContractResponse extends BaseResponse{
	...
	/**
	 * @param listContract the listContract to set
	 */
