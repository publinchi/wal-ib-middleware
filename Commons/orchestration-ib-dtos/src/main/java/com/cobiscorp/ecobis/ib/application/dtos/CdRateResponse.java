...
<script type="text/javascript">
	var nombreClase       = "CdRateResponse";
	var tipoDato          = ["List < Rate >", "CertificateDepositResponse"];
	var nombreAtributo    = ["listRate", "certificateDepositResponse"];
 ...
 * @version 1.0.0
 */
public class CdRateResponse extends BaseResponse{
	...
	/**
	 * @param listRate the listRate to set
	 */
