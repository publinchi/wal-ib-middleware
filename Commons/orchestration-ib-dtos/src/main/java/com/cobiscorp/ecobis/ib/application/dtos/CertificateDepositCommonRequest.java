...
<script type="text/javascript">
	var nombreClase       = "CertificateDepositCommonRequest";
	var tipoDato          = ["CertificateDeposit", "Entity"];
	var nombreAtributo    = ["certificateDeposit", "entity"];
 ...
 * @version 1.0.0
 */
public class CertificateDepositCommonRequest extends BaseRequest{
