 ...
 *
 */
class Test_ib_accounts_master_query_orchestration {
	@ClassRule
	...
	void testgetSelectionMasterAccount() {
		println ' ****** Prueba Regresión testgetSelectionMasterAccount Persona Natural************* '
		...
		try{
			...
			wEntityServiceProduct.entityId = 277;// CTSEnvironment.bvEnte;//@i_cliente
			wEntityServiceProduct.productId= 3;//@i_producto
			wEntityServiceProduct.productNumber=CTSEnvironment.bvAccCtaCteNumber;//@i_cuenta 
			...
			wEntityServiceProduct.userName=CTSEnvironment.bvLogin;//@i_login			
