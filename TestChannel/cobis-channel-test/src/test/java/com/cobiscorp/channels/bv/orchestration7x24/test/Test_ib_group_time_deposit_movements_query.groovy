...
class Test_ib_group_time_deposit_movements_query {
	...
	void testgetTimeDepositMovements(){
		...
		try {
			...
			enquiryRequest.productNumber = CTSEnvironment.bvGroupDpfNumber;//@i_num_banco
			...
			enquiryRequest.productNumber=CTSEnvironment.bvGroupDpfNumber;//@i_cta
			enquiryRequest.currencyId=CTSEnvironment.bvGroupDpfCurrencyId;//@i_mon
