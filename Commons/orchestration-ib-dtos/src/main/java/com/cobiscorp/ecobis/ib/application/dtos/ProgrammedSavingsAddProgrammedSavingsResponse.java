...
<script type="text/javascript">
	var nombreClase       = "ProgrammedSavingsAddProgrammedSavingsResponse";
	var tipoDato          = ["TransferResponse"];
	var nombreAtributo    = ["transferResponse"];
 ...
 * @version 1.0.0
 */
public class ProgrammedSavingsAddProgrammedSavingsResponse extends BaseResponse{
