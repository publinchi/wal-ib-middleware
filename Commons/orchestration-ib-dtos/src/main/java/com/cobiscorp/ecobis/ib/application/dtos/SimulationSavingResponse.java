...
<script type="text/javascript">
	var nombreClase       = "SimulationSavingResponse";
	var tipoDato          = ["SimulationSaving"];
	var nombreAtributo    = ["simulationSaving"];
 ...
 * @version 1.0.0
 */
public class SimulationSavingResponse extends BaseResponse {
	...
	public String toString() {
		return "SimulationSavingResponse [simulationSaving=" + simulationSaving
				+ "]";
	}
