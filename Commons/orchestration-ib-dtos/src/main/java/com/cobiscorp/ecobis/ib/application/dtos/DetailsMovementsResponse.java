...
<script type="text/javascript">
	var nombreClase       = "DetailsMovementsResponse";
	var tipoDato          = ["List<AccountStatement>"];
	var nombreAtributo    = ["AccountStatementsCollection"];
 ...
 * @version 1.0.0
 */
public class DetailsMovementsResponse extends BaseResponse {
	 ...
	 */
	public void setAccountStatementsCollection(
			List<AccountStatement> accountStatementsCollection) {
