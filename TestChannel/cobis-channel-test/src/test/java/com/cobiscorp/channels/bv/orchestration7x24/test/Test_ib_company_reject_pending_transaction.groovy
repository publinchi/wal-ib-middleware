...
public class Test_ib_company_reject_pending_transaction {
	@ClassRule
	 ...
	 */
	@Test
	void testCompanyRejectPendingAuthorization(){
		String ServiceName='CompanyRejectPendingAuthorization'
		
		def IdAuthorization = virtualBankingBase.OperationNumber(CTSEnvironment.bvCompanyLoginA, 18056) //3558
		try{
