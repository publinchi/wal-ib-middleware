 ...
 *
 */
public class Test_ib_company_sign_validation_third_account_transfer {
	@ClassRule
	...
	def SsnBranch = "0"
	 ...
	 def TransferToThirdAuthorization() {
		String ServiceName='CompanyTransferToThirdAuthorization'
		def SsnBranch = "0"
		try{
			...
			wProductDestino.productAlias="Company Producto Alias Destino"
			...
			Assert.assertNotNull("No se obtuvo Numero de Comprobante",SsnBranch)
