...
class Test_ib_get_balance_card {
	...
	void testGetCardBalance() {
		def ServiceName='testGetCardBalance'
		try{
			...
			wuser.name=CTSEnvironment.bvLogin; //testCts
			wRequestCreditCard.card= CTSEnvironment.bvAccTarNumber;
			wRequestCreditCard.productId= Integer.parseInt(CTSEnvironment.bvAccTarType); 
