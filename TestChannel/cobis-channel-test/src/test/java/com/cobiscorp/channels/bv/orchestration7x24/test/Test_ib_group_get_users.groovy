...
class Test_ib_group_get_users {
	...
	void GetUsers(String pSession,  String pLogin)
	{
		...
		try
		{
			...
			for(int i =1;i<=5;i++)
			{
				Assert.assertNotNull("Parámetro "+"@o_login_op"+i.toString()+" is null",  serviceResponseTO.data.get("com.cobiscorp.cobis.cts.service.response.output").getAt("@o_login_op"+i.toString()))
			...
			//Assert.assertNotNull("Parámetro @o_login_new is null",  serviceResponseTO.data.get("com.cobiscorp.cobis.cts.service.response.output").getAt("@o_login_new"))
			Assert.assertNotNull("Parámetro @o_login_old is null",  serviceResponseTO.data.get("com.cobiscorp.cobis.cts.service.response.output").getAt("@o_login_old"))
	...
	void testGetUsers() {
		...
		GetUsers(initSession, CTSEnvironment.bvGroupLogin)
	}
}
