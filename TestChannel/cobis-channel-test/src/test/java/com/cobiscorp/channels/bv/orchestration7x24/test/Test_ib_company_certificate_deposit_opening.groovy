 ...
 *
 */
class Test_ib_company_certificate_deposit_opening {
	@ClassRule
	...
	void testCertificateDepositOpening() {
		println ' ****** Prueba Regresión testCertificateDepositOpening Persona Juridica************* '
		...
		try{
			...
			wUser.entityId=CTSEnvironment.bvCompanyEnteMis;//137488;
			wUser.name=CTSEnvironment.bvCompanyLogin;//@i_login;
			wTransactionContextCIB.authenticationRequired="N";
			
			wProduct.productNumber="10410108275405315";//CTSEnvironment.bvCompanyAccCtaAhoNumber;//@i_cta;
			wProduct.currencyId=CTSEnvironment.bvCompanyAccCtaAhoCurrencyId;//@i_mon;
			wProduct.productId=3;//CTSEnvironment.bvCompanyAccCtaAhoType;//@i_prod;
			...
			//
			println "******** Output Opening Certificate Deposit Juridico*********"
