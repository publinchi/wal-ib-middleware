 ...
 * @author gyagual                                                                      
 */
class TestNaturalProspectiveCustomer {
	/**
	...
	@Test
	void TestNaturalProspectiveCustomerbyCode() {
	...
	@Test
	void TestNaturalProspectiveCustomerbyAlphabetical() {
	...
	@Test
	void TestNaturalProspectiveCustomerbyMarriedName() {
	...
	@Test
	void TestNaturalProspectiveCustomerbyId() {
