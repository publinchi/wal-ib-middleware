...
public class Test_ib_group_changeAlias_orchestration {
	@ClassRule
	...
	@Test
	void testGroupCCChangeAlias() {
		def ServiceName= 'testGroupCCChangeAlias'
		try{
			println "Test ---> ${ServiceName}"
			
			GetInformationByClient(CTSEnvironment.bvService, CTSEnvironment.bvGroupEnte, CTSEnvironment.bvGroupAccCtaCteNumber, CTSEnvironment.bvGroupLogin  )
			ChangeAlias(CTSEnvironment.bvGroupAccCtaCteType, CTSEnvironment.bvGroupAccCtaCteNumber, CTSEnvironment.bvGroupAccCtaCteCurrencyId, CTSEnvironment.bvGroupLogin, "CTA TESTPRUEBA_CC" )
			GetInformationByClient(CTSEnvironment.bvService, CTSEnvironment.bvGroupEnte, CTSEnvironment.bvGroupAccCtaCteNumber, CTSEnvironment.bvGroupLogin  )
	...
	@Test
	void testGroupAhChangeAlias() {
		def ServiceName= 'testGroupAhChangeAlias'
		try{
			println "Test ---> ${ServiceName}"
			
			GetInformationByClient(CTSEnvironment.bvService, CTSEnvironment.bvGroupEnte, CTSEnvironment.bvGroupAccCtaAhoNumber, CTSEnvironment.bvGroupLogin )
			ChangeAlias(CTSEnvironment.bvGroupAccCtaAhoType, CTSEnvironment.bvGroupAccCtaAhoNumber, CTSEnvironment.bvGroupAccCtaAhoCurrencyId, CTSEnvironment.bvGroupLogin, "CTA TESTPRUEBA_AH" )
			GetInformationByClient(CTSEnvironment.bvService, CTSEnvironment.bvGroupEnte, CTSEnvironment.bvGroupAccCtaAhoNumber, CTSEnvironment.bvGroupLogin )
