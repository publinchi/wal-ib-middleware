 ...
 *
 */
class Test_ib_company_get_savings_account_statement {
	@ClassRule
	...
	@Test
	void testGetSavingAccountStatement() {
		def ServiceName='testGetSavingAccountStatement'
		try{
			...
			serviceRequestTO.setServiceId('InternetBanking.WebApp.Enquiries.AccountStatement.GetSavingsAccountStatement')
			...
			wAccountStatement.sequential   = 5;
