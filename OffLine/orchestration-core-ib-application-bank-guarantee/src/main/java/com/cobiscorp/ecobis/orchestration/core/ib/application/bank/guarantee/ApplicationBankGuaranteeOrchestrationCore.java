...
public class ApplicationBankGuaranteeOrchestrationCore extends ApplicationOfflineTemplate {
	...
	/**
	 * Deleting MonetaryTransaction Interface
	 * 
	 * @param service
	 */
	...
	private IProcedureResponse transformProcedureResponse(
		...
		if (aApplicationBankGuaranteeResponse.getReturnCode() != 0
				&& aApplicationBankGuaranteeResponse.getReturnCode() != 40002) {
