...
class Test_ib_group_time_deposit_payment_detail_schedule_query {
	...
	void testgetTimeDepositsPaymentDetailSchedule(){
		...
		try {
			...
			enquiryRequest.productNumber = CTSEnvironment.bvGroupAccDpfNumberPaysched;//@i_op_num_banco
			enquiryRequest.dateFormatId = CTSEnvironment.bvDateFormat;//@i_formato_fecha
			enquiryRequest.currencyId=CTSEnvironment.bvGroupAccDpfCurrencyidHist;//@i_mon
			enquiryRequest.productId=CTSEnvironment.bvGroupAccDpfProductidHist;//@i_product
