...
class Test_ib_company_time_deposit_historicals_query {
	...
	void testgetTimeDepositHistoricals(){
		...
		try {
			...
			enquiryRequest.userName = CTSEnvironment.bvCompanyLogin;//@i_login
			enquiryRequest.productNumber = CTSEnvironment.bvCompanyAccDpfNumberHist;//@i_num_banco
			...
			enquiryRequest.productId=CTSEnvironment.bvCompanyAccDpfProductidHist;//@i_prod
