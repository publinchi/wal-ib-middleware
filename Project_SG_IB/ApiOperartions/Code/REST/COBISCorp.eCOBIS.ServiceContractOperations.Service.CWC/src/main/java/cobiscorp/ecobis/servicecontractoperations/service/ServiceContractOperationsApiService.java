    ...
    */
	   ...
	   throw new CTSRestException("404",null);
		...
		/**
          ...
          */
		  @Override
		  // Return List
		  public  ResponseUpdateAccountStatus  updateAccountStatus(RequestUpdateAccountStatus inRequestUpdateAccountStatus  )throws CTSRestException{
	...
	int mapBlank=0;
		  ...
		  if (response.getResultSets()!=null&&response.getResultSets().get(0).getData().getRows().size()>0) {
				  ...
				  outSingleResponseUpdateAccountStatus=returnResponseUpdateAccountStatus ;
