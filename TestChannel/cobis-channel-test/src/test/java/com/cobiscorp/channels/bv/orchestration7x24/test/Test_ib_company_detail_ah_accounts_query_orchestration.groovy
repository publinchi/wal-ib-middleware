 ...
 * @version 1.0.0
 */
public class Test_ib_company_detail_ah_accounts_query_orchestration {
	...
	@Test
	void testGetSavingsAccountOperationDetailCompany() {
		...
		try{
			...
			wAccountStatement.operationType=264
