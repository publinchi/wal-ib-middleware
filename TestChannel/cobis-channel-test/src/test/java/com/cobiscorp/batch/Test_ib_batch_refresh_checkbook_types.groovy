...
class Test_ib_batch_refresh_checkbook_types {
	...
	void testExecuteNotification() {
		...
		def cont = 1;	
		def num_registros = 13;
		def siguiente = 0;
		def fecha_proceso = '10/01/2013'
		/*
		...
		*/	
		...
		/*exec sp_replica_cc_tchequera
			@i_filial = 1,
			@i_fecha_proceso = '01/01/2014',
			@i_numero_registros = 10
		*/
			def wRequestJavaOrchCentralCTE = '''<?xml version="1.0" encoding="ISO-8859-1" ?>
					<CTSMessage>
						...
						<Data>
							<ProcedureRequest>
								<SpName>cob_procesador..sp_replica_orq_tchequera</SpName>
								<Param name="@t_trn" type="56" io="0" len="7">1890009</Param>
								<Param name="@i_sarta" type="56" io="0" len="7">1</Param>
								<Param name="@i_batch" type="56" io="0" len="7">1</Param>
		...
		<CTSMessage>
                ...
                <Data>
                                <ProcedureRequest>
                                                ...
                                                <Param name="@i_corrida" type="56" io="0" len="1">1</Param>
                                                <Param name="@i_intento" type="56" io="0" len="1">1</Param>
                                    			<Param name="@i_operacion" type="56" io="0" len="1">4</Param>
                                </ProcedureRequest>
                </Data>
		</CTSMessage>
                                '''
