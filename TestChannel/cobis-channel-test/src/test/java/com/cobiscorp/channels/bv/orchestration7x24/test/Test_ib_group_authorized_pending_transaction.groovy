...
public class Test_ib_group_authorized_pending_transaction {
	@ClassRule
	 ...
	 */
	@Test
	void testGroupApprovePendingAuthorization(){
		String ServiceName='GroupApprovePendingAuthorization'
		
		def IdAuthorization = virtualBankingBase.OperationNumber(CTSEnvironment.bvCompanyLoginA, 18056) //2972
		try{
			...
			wLoginPending.reason = "REASON: APPROVE PENDING TRANSACTION"
