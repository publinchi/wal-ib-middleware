...
public class ApplicationDisbursementCreditLineOrchestrationCore extends ApplicationOnlineTemplate {
	...
	/*
	 * @Reference(referenceInterface = ICoreServiceMonetaryTransaction.class,
	 * cardinality = ReferenceCardinality.OPTIONAL_UNARY, bind =
	 * "bindCoreServiceMonetaryTransaction", unbind =
	 * "unbindCoreServiceMonetaryTransaction") protected
	 * ICoreServiceMonetaryTransaction coreServiceMonetaryTransaction;
	 */
	...
	/*
	 * public void
	 * bindCoreServiceMonetaryTransaction(ICoreServiceMonetaryTransaction
	 * service) { coreServiceMonetaryTransaction = service; }
	 */
	...
	/*
	 * public void
	 * unbindCoreServiceMonetaryTransaction(ICoreServiceMonetaryTransaction
	 * service) { coreServiceMonetaryTransaction = null; }
	 */
	...
	protected IProcedureResponse executeApplicationCheckbook(IProcedureRequest request,
		...
		/*
		 * try { logger.logInfo("executeQuery"); messageError=
		 * "get: ERROR EXECUTING SERVICE";
		 * logger.logDebug("request RequestCheckbook: "+request); messageLog =
		 * "getRequestCheckbook: "+
		 * aRequestCheckbookRequest.getAuthorizationRequired(); queryName =
		 * "getRequestCheckbook";
		 * 
		 * aRequestCheckbookRequest.setOriginalRequest(request);
		 * logger.logInfo("LLAMA coreServiceCheckbook.getRequestCheckbook");
		 * aRequestCheckbookResponse =
		 * coreServiceCheckbook.getRequestCheckbook(aRequestCheckbookRequest);
		 * 
		 * } catch (CTSServiceException e) { e.printStackTrace(); if
		 * (logger.isDebugEnabled()) logger.logDebug(messageError); return null;
		 * } catch (CTSInfrastructureException e) { e.printStackTrace(); if
		 * (logger.isDebugEnabled()) logger.logDebug(messageError); return null;
		 * }
		 */
