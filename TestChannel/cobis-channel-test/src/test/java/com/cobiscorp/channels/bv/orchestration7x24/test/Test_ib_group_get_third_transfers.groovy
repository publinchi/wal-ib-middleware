 ...
 *
 */
public class Test_ib_group_get_third_transfers {
	@ClassRule
	 ...
	 */
	@Test
	void testGetGroupThirdTransfers() {
		String ServiceName='GroupGetThirdTransfers'
		try{
			...
			//DTO IN
			 ...
			 SearchOption wSearchOption = new SearchOption();
				wEnquiryRequest.productNumber=  CTSEnvironment.bvGroupThirdTransfersNumber; 
