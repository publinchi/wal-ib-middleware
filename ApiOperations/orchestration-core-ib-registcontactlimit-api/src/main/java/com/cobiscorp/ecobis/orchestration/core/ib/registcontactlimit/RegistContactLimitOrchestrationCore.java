...
public class RegistContactLimitOrchestrationCore extends SPJavaOrchestrationBase {// SPJavaOrchestrationBase
  ...
  private JsonObject createRequestBody(IProcedureRequest originalProcedureRequest) {
    ...
    BigDecimal contactAmount = new BigDecimal(amountStr);
    if (contactAmount != null && contactAmount.compareTo(BigDecimal.ZERO) > 0) {
    ...
    logger.logInfo(className + " createRequestBody: " + jsonRequest);
    return jsonRequest;
  }
