...
public class Test_ib_group_detail_loan_orchestration {
	...
	/**
	 * this method return the details of loan for an user type group
	 */

	@Test
	void testGetDetailLoanQueryGroup() {
		def ServiceName= 'testGetDetailLoanQueryGroup'
		try{
			...
			wEnquiryRequest.productNumber = CTSEnvironment.bvGroupLoanNumber
