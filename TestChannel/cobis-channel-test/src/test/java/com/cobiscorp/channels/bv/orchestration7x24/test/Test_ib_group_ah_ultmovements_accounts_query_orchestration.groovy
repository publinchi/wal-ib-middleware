...
// PRODUCT: SAVINGS ACCOUNT,  TYPE USER: GROUP 
class Test_ib_group_ah_ultmovements_accounts_query_orchestration {
	@ClassRule
	...
	@Test
	void TestGroupGetAHUltMovementsQuery () {
		def ServiceName='TestGroupGetAHUltMovementsQuery'
		try{
