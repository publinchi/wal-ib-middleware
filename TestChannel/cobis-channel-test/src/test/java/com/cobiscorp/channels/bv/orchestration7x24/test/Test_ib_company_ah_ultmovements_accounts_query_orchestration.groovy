...
// PRODUCT: SAVINGS ACCOUNT,  TYPE USER: COMPANY 
public class  Test_ib_company_ah_ultmovements_accounts_query_orchestration {
	@ClassRule
	...
	@Test
	void TestCompanyGetAHUltMovementsQuery () {
		def ServiceName='TestCompanyGetAHUltMovementsQuery'
		try{
