 ...
 * @version 1.0.0
 */
class Test_ib_group_cc_detail_movements_query_orchestration {
	...
	@Test
	void testGetMovementsDetailCheckingAccountGroup() {
		def ServiceName='testGetMovementsDetailCheckingAccountGroup'
		try{
			...
			wEnquiryRequest.productId=CTSEnvironment.bvGroupAccCtaCteType
			wEnquiryRequest.currencyId=CTSEnvironment.bvGroupAccCtaCteCurrencyId
			...
			wAccountStatement.sequential = 656033786
