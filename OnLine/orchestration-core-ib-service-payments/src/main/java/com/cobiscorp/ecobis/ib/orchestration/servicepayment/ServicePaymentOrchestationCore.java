...
public class ServicePaymentOrchestationCore extends PaymentOnlineTemplate {
	...
	protected NotificationRequest transformNotificationRequest(IProcedureRequest aProcedureRequest,
		...
		product.setProductType(Integer.parseInt(aProcedureRequest.readValueParam("@i_prod")));
		if (!Utils.isNull(aProcedureRequest.readParam("@i_cta")))
			product.setAccountNumberDebit(aProcedureRequest.readValueParam("@i_cta"));
	...
	private PaymentServiceRequest transformToPaymentServiceRequest(IProcedureRequest aRequest) {
		 ...
		 * inUser.setServiceId(Integer.parseInt(aRequest.readValueParam(
		 * "@i_canal"))); }
		 */
		if (aRequest.readValueParam("@s_servicio") != null) {
			inUser.setServiceId(Integer.parseInt(aRequest.readValueParam("@s_servicio")));
		}
