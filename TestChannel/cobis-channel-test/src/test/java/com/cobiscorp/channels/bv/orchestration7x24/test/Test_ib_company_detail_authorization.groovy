...
class Test_ib_company_detail_authorization {
	@ClassRule
	...
	///Detail Authorization Transfers Own Acount
	@Test
	
	void testCompanyDetailTransfer()
	{
		int TransaccionCtasPropias = virtualBankingBase.OperationNumber(CTSEnvironment.bvCompanyLoginA, 18056)
		testCompanyLoginAuthorization(TransaccionCtasPropias, 'Cuentas Propias')
				
		int TransaccionPago =virtualBankingBase.OperationNumber(CTSEnvironment.bvCompanyLoginA, 1800025)
		testCompanyLoginAuthorization(TransaccionPago,'Pagos')
		
		/*
		testCompanyLoginAuthorization(2193,'Cuentas Propias')	//detalle de transferecia cuentas propias
		testCompanyLoginAuthorization(2775,'terceros')			//detalle de transferecia a terceros
		testCompanyLoginAuthorization(2193,'Pagos')				//detalle de pagos 
		*/
	}
	
	
	void testCompanyLoginAuthorization(int transaccion, String tipoconsulta) {
