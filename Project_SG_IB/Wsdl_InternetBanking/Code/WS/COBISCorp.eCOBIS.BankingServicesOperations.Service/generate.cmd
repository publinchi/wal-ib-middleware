...
REM copio XSDs del DTO
    ...
    xcopy /Y /E /R "C:\Trafalgar\middleware_22\trf-ib-middleware\Project_SG_IB\Wsdl_InternetBanking\Code\WS\COBISCorp.eCOBIS.BankingServicesOperations.DTO\webapp\wsdl" "%PROJECT_DIR%\webapp\wsdl" /i
...
wsimport "%PROJECT_DIR%/webapp/wsdl/COBISCorp.eCOBIS.BankingServicesOperations.Service.wsdl" -d "%PROJECT_DIR%\src" -b "%PROJECT_DIR%/webapp/wsdl/binding.jxb" -Xnocompile
