...
class Test_ib_personal_SetSelfClearingNotification {
	@ClassRule
	 ...
	 */
	@Test
	void testNaturalSetSelfClearingNotification(){
		String ServiceName='SetSelfClearingNotification'
		try{
			println String.format('Test [%s]',ServiceName)
			// Preparo ejecución del servicio
			ServiceRequestTO serviceRequestTO = new ServiceRequestTO()
			serviceRequestTO.setSessionId(initSession)
			serviceRequestTO.setServiceId('InternetBanking.WebApp.Admin.Notification.SetSelfClearingNotification')
			//DTO IN
			...
			wNotification.setId("16630");
			wNotification.setSelfClearingDate("01-01-2017");
