...
<script type="text/javascript">
	var nombreClase       = "AddressResponse";
	var tipoDato          = ["Address", "Client"];
	var nombreAtributo    = ["addressCollection", "clientCollection"];
...
public class AddressResponse extends BaseResponse{
	...
	private Client clientCollection;
	 ...
	 */
	public void setClientCollection(Client clientCollection) {
