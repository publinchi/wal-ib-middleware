...
class Test_ib_simulator_maxsaving_query {
	...
	void testgetSimulationSaving(){
		println ' ****** Prueba Regresión testSimulationMaxSaving ************* '
		def ServiceName = 'getSimulationMaxSaving'
		try {
			...
			for (var in aSavingSim) {
				...
				println "maxAmount "+ var.maxAmount;
