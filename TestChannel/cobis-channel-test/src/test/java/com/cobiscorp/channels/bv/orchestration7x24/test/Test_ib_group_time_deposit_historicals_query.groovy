...
class Test_ib_group_time_deposit_historicals_query {
	...
	void testgetTimeDepositHistoricals(){
		...
		try {
			...
			enquiryRequest.productNumber = CTSEnvironment.bvGroupAccDpfNumberHist;//@i_num_banco
			...
			enquiryRequest.productId=CTSEnvironment.bvGroupAccDpfProductidHist;//@i_prod
