 ...
 *
 */
class Test_ib_time_deposit_payable_interests_query {
	...
	void testgetTimeDepositPayableInterests(){
		...
		try {
			...
			enquiryRequest.productNumber = CTSEnvironment.bvAccDpfPayableProdNumber;//@i_cuenta @i_cta
			...
			searchOption.sequential = CTSEnvironment.bvAccDpfPayableSequence;//@i_cuota
			...
			println "******** Resulset *********"
			//println "Tamaño" + oPayableInterestResponse.length();
