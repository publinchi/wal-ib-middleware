...
class Test_ib_group_get_balance_card {
	...
	@Test
	void testGetCardBalanceGroup() {
		def ServiceName='testGetCardBalanceGroup'
		try{
			...
			wuser.name=CTSEnvironment.bvGroupLogin; //testCts
			wRequestCreditCard.card= CTSEnvironment.bvAccGroupTarNumber;
			wRequestCreditCard.productId= Integer.parseInt(CTSEnvironment.bvAccGroupTarType);
