 ...
 *
 */
class Test_ib_company_management_notification_query {
	@ClassRule
	...
	void testMeanNotifications(){
		println ' ****** Prueba Regresión testManagementNotifications Persona Juridica ************* '
		...
		try {
			...
			if (method.equals("Edit")){
				...
				wProductNotification.productId=CTSEnvironment.bvCompanyAccCtaAhoType;//@i_prod;
				wProductNotification.userName=CTSEnvironment.bvCompanyLogin;//@i_login;
				wProductNotification.productNumber=CTSEnvironment.bvCompanyAccCtaAhoNumber;//@i_cta;
				wProductNotification.currencyId=CTSEnvironment.bvCompanyAccCtaAhoCurrencyId;//@i_moneda;
				...
				if(wOperacion.equals("I")){
					...
					if (method.equals('ProductNotificationDelivery'))
					{
						...
						wNotificationDelivery.deliveryMethodId=CTSEnvironment.bvCompanyEnte;//277 natural - 21 empresa
					}
				...
				if(wOperacion.equals("D")){
					...
					if (method.equals('ProductNotificationDelivery'))
					{
						...
						wNotificationDelivery.deliveryMethodId=CTSEnvironment.bvCompanyEnte;
					}
				}
				wNotificationDelivery.productId=CTSEnvironment.bvCompanyAccCtaAhoType;//@i_prod; 4
				wNotificationDelivery.userName=CTSEnvironment.bvCompanyLogin;//@i_login;
				wNotificationDelivery.productNumber=CTSEnvironment.bvCompanyAccCtaAhoNumber;//@i_cta;
				wNotificationDelivery.notificationId="N19";//N19  N32
				wNotificationDelivery.currencyId=CTSEnvironment.bvCompanyAccCtaAhoCurrencyId;//@i_moneda; 0
