 ...
 *
 */
class Test_ib_receipts_reprint_query {
	...
	@Test
	void testReciepts(){
		println ' ****** Prueba Regresión testReciepts Persona Natural ************* '
