 ...
 *
 */
class Test_ib_group_consolidated_detailed_orchestration {
	@ClassRule
	...
	/**
	 * Consulta detallada de Corrientes y Ahorros - Grupo
	 */
	@Test
	void testGetSummaryProductsAllAccountsGroup() {
		
		println ' ****** Prueba Regresión testGetSummaryProductsAllAccountsGroup ************* '
		GetSummaryProducts(initSession, CTSEnvironment.bvGroupEnte, CTSEnvironment.bvGroupLogin, 0,CTSEnvironment.bvGroupEnteMis)
	
	}
	/**
	 * Consulta detallada de Corrientes - Grupo
	 */
	@Test
	void testGetSummaryProductsCheckingAccountGroup() {
		
		println ' ****** Prueba Regresión testGetSummaryProductsCheckingAccountGroup ************* '
		GetSummaryProducts(initSession, CTSEnvironment.bvGroupEnte, CTSEnvironment.bvGroupLogin, 3,CTSEnvironment.bvGroupEnteMis)
	
	}
	
	/**
	 * Consulta detallada de Ahorros - Grupo
	 */
	@Test
	void testGetSummaryProductsSavingAccountGroup() {
		
		println ' ****** Prueba Regresión testGetSummaryProductsSavingAccountGroup ************* '
		GetSummaryProducts(initSession, CTSEnvironment.bvGroupEnte, CTSEnvironment.bvGroupLogin, 4,CTSEnvironment.bvGroupEnteMis)
	
	}
	
	
	/**
	 * Consulta detallada de Préstamos - Grupo
	 */
	@Test
	void testGetSummaryProductsLoanGroup() {
		
		println ' ****** Prueba Regresión testGetSummaryProductsLoanGroup ************* '
		GetSummaryProducts(initSession, CTSEnvironment.bvGroupEnte, CTSEnvironment.bvGroupLogin, 7,CTSEnvironment.bvGroupEnteMis)
	 ...
	 */
	@Test
	void testGetSummaryProductsTimeDepositsGroup() {
		
		println ' ****** Prueba Regresión testGetSummaryProductsTimeDepositsGroup ************* '
		GetSummaryProducts(initSession, CTSEnvironment.bvGroupEnte, CTSEnvironment.bvGroupLogin, 4,CTSEnvironment.bvGroupEnteMis)
