 ...
 * Class:MovementsAccountsQueryOrchestrationCore
 *
 * @author gcondo	
 * @since Jul 23, 2014
 * @version 1.0.0
 */
class Test_ib_cc_detail_movements_query_orchestration {
	@ClassRule
	...
	@Test
	void testGetMovementsDetailCheckingAccount() {
		def ServiceName='testGetMovementsDetailCheckingAccount'
		try{
			...
			wAccountStatement.sequential = 655970404
			wAccountStatement.alternateCode = 3
			wAccountStatement.operationType = 2796
