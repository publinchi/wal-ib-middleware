 ...
 *
 */
class Test_ib_company_accounts_master_query_orchestration {
	@ClassRule
	...
	void testgetSelectionMasterAccount() {
		println ' ****** Prueba Regresión testgetSelectionMasterAccount Company************* '
		...
		try{
			...
			wEntityServiceProduct.entityId = 279;// CTSEnvironment.bvEnte;//@i_cliente
			...
			wEntityServiceProduct.userName=CTSEnvironment.bvCompanyLogin;//@i_login			
