 ...
 *
 */
class Test_ib_group_receipts_reprint_query {
	...
	@Test
	void testReciepts(){
		println ' ****** Prueba Regresión testReciepts Grupo ************* '
		...
		try {
			...
			wSearchOption.sequential=0;//i_siguiente
			//wSearchOption.criteria="P";
			//-----------------------------------
			if (wOperacion =="S"){
				wSearchReceipts.paymentType="J";
				/*
				 ...
				 */
				wSearchReceipts.debitAccount="10410000005233616";//A,F-->CTSEnvironment.bvAccCtaAhoNumber;
				wSearchReceipts.startDate="05/02/2012";
				wSearchReceipts.endDate="01/02/2014";
				wSearchReceipts.paidService=null;//A,F CTSEnvironment.bvDestinationAccCtaCteNumber;-->i_cta_credito
				//wSearchReceipts.idService=0;//A,F-->i_convenio
				wSearchReceipts.idService=120;//H -->i_convenio
