...
public class Test_ib_detail_loan_orchestration {
	...
	/**
	 * this method return the details of loan for a user  type Natural
	 */

	@Test
	void testGetDetailLoanQueryNatural() {
		def ServiceName= 'testGetDetailLoanQueryNatural'
		try{
