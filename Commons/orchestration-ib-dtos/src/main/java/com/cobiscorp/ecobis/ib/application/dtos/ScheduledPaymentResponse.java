...
<script type="text/javascript">
	var nombreClase       = "ScheduledPaymentResponse";
	var tipoDato          = ["Integer","Integer"];
	var nombreAtributo    = ["reference","branchSSN"];
 ...
 * @version 4.5.0.0
 */
public class ScheduledPaymentResponse extends BaseResponse {
