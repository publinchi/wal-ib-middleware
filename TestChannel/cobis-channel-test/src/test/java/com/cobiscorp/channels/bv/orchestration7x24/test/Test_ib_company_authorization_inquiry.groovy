...
class Test_ib_company_authorization_inquiry {
	@ClassRule
	...
	@Before
	void setUp(){
		//virtualBankingBase.executeLoadDobleAutorizacionCompany()
	...
	void testCompanyAuthorization() {
		...
		try{
			...
			wTransactionRequest.userName = CTSEnvironment.bvCompanyLogin
