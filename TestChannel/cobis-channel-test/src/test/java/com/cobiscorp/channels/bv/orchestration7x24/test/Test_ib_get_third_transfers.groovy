 ...
 *
 */
public class Test_ib_get_third_transfers {
	@ClassRule
	 ...
	 */
	@Test
	void testGetThirdTransfers() {
		String ServiceName='GetThirdTransfers'
		try{
			...
			//DTO IN
			 ...
			 SearchOption wSearchOption = new SearchOption();
				 wEnquiryRequest.productNumber=  CTSEnvironment.bvThirdTransfersNumber; 
