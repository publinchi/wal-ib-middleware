...
class Test_ib_group_update_customer {
	...
	void testUpdateCustomer() {
		...
		try{
			...
			wCustomer.entityId = CTSEnvironment.bvGroupEnteMis
			wCustomer.phoneId = 1
			wCustomer.emailId = 1
			...
			wAddress.id = 2
			wAddress.neighborhood = CTSEnvironment.bvNeighborhood//"Neigborhood Test"
			wAddress.street = CTSEnvironment.bvStreet ///"Street Test"
			wAddress.house = CTSEnvironment.bvHouse//"House Test"
			wAddress.description = "Description Test" 
